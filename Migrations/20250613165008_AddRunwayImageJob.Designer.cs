...
namespace PhotoAiBackend.Migrations
{
    ...
    [Migration("20250613165008_AddRunwayImageJob")]
    partial class AddRunwayImageJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoAiBackend.Persistance.Entities.RunwayImageJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("FailureCode")
                        .HasColumnType("text")
                        .HasColumnName("failure-code");

                    b.Property<string>("FailureReason")
                        .HasColumnType("text")
                        .HasColumnName("failure-reason");

                    b.Property<int>("ImageJobId")
                        .HasColumnType("integer")
                        .HasColumnName("image-job-id");

                    b.Property<string>("RunwayTaskId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("runway-task-id");
                    ...
                    b.HasIndex("ImageJobId");

                    b.ToTable("runway-image-jobs");
                });
            ...
            modelBuilder.Entity("PhotoAiBackend.Persistance.Entities.RunwayImageJob", b =>
                {
                    b.HasOne("PhotoAiBackend.Persistance.Entities.ImageJob", "ImageJob")
                        .WithMany()
                        .HasForeignKey("ImageJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImageJob");
                });
