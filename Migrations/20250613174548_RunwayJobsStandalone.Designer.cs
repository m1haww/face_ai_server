...
namespace PhotoAiBackend.Migrations
{
    ...
    [Migration("20250613174548_RunwayJobsStandalone")]
    partial class RunwayJobsStandalone
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotoAiBackend.Persistance.Entities.RunwayImageJob", b =>
                {
                    ...
                    b.Property<string>("OutputUrls")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("output-urls");
